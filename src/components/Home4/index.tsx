...
const Home4: React.FC<IHome4>=({Opacity})=> {
  const list = [
    ['2023.Q1 ', 'FNS official launch on Findora',  'l1'],
    ['2023.Q2 ', '.fra support for more on-chain assets and social data integration',  'l2'],
    ['2023.Q3 ', 'Zero-knowledge proof integration to hide ownership.',  'l3'],
    ['2023.Q4 ', 'Deploy selective disclosure of personal information through data ownership with FNS. The goal is to give users control of their identity in gaming, social media, DAOs, and community governance.  ', 'l4'],
  ];
